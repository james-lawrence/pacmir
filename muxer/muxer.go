...
import (
	...
	"github.com/james-lawrence/pacmir/internal/errorsx"
...
func Background(ctx context.Context, m *M, l net.Listener) {
	if err := Listen(ctx, m, l); err != nil {
		log.Println(errors.Wrap(err, "listen failed"))
	}
}
